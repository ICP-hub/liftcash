  ...
  const blogs = [
    {
      ...
      image: "https://plus.unsplash.com/premium_photo-1681487464375-7cde580bf4ec?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    ...
    {
      title: 'Implementing a Sortition-based DAO for Policymaking and AI Governance',
    ...
    <div className="blog-section-main">
      ...
      <h1 className="section-title-h1">Our Blogs</h1>
        ...
        <p className="section-subtitle">
          There are many variations of passages of Lorem Ipsum <br />available but the
