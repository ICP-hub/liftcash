...
import { canisterId, createActor } from '../../../declarations/Lift_Cash_backend/index.js';
...
export default function AuthComponent({ closeModal }) {
  ...
  return (
    <div className='flex justify-center'>
      <button className='flex flex-row justify-center gap-5 items-center bg-blue-500 text-white rounded-lg w-[90%] mt-4 align-center'
        onClick={() => {
          authenticate();
        }}
      >
